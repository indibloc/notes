...
func main() {
	...
	log.Fatal(http.ListenAndServe(httpPort, FileServer(Dir(*flDir))))
}

//---- copied from net/http/server.go
const sniffLen = 512   //sniff.go
...
//----------- TODO: Remove this to saperate file and clean up [ copied from: net/http/fs.go]
// just to trap the NotFound function
